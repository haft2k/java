...
public class Order implements Comparable<Order> {
	...
	@Override
	public int compareTo(Order o) { return this.getPrice().compareTo(o.getPrice()); }
	 ...
	 * @return the sIDStock
	 */
	public String getsIDStock() { return sIDStock; }

	/**
	 * @param sIDStock the sIDStock to set
	 */
	public void setsIDStock(String sIDStock) { this.sIDStock = sIDStock; }

	/**
	 * @return the sIDTrader
	 */
	public String getsIDTrader() { return sIDTrader; }

	/**
	 * @param sIDTrader the sIDTrader to set
	 */
	public void setsIDTrader(String sIDTrader) { this.sIDTrader = sIDTrader; }
